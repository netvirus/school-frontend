...
import { addBookService, getBookByIdService, updateBookService } from "../../servicea/PaymentService.js";
...
// Валидация полей
    ...
    function saveOrUpdateButton() {
        if (id) {
            return <button type="button" className="btn btn-primary me-2" onClick={saveOrUpdatePayment}>Update</button>
        } else {
            return <button type="button" className="btn btn-primary me-2" onClick={saveOrUpdatePayment}>Save</button>
        }
    }
